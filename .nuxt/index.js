...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Chicago EV","titleTemplate":"%s || Chicago EV","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Chicago EV sells and installs electric vehicle chargers in the Chicagoland area."},{"hid":"keywords","name":"keywords","content":"ev chargers, ev program, electric vehicles, chicago ev, semaconnect, clipper creek, chicago car chargers"},{"hid":"og:title","property":"og:title","content":"Chicago EV"},{"hid":"og:url","property":"og:url","content":"http:\u002F\u002Fev-chicago.herokuapp.com"},{"hid":"og:description","property":"og:description","content":"Chicago EV sells and installs electric vehicle chargers in the Chicagoland area. Whether you own a shopping outlet, a parking garage, a fleet of electric vehicles, or any other commercial business, we have a solution that best fits your needs."},{"hid":"og:image","property":"og:image","content":"https:\u002F\u002Fev-chicago.herokuapp.com\u002Fimages\u002Fslider\u002FChicago-EV.jpg"},{"hid":"t-type","name":"twitter:card","content":"summary_large_image"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"htmlAttrs":{"lang":"en"},"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_595a4e99 === 'function') {
    await nuxt_plugin_plugin_595a4e99(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_67eb026b === 'function') {
