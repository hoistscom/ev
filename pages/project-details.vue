<template>
    <div class="main-container">
        ...
        <div class="project-details-banner bg-cover" :style="{ backgroundImage: `url('/images/project/large-project.jpg')` }"></div>
        ...
        <div class="section-padding-top">
            <div class="container">
                    ...
                    <div class="col-lg-8 offset-lg-2 col-md-12">
                        ...
                        <div class="project-details-content" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div class="info-boxed">
                                <ul>
                                    <li><span>location</span>Addess goes here</li>
                                    <li><span>client</span>Country Goverment</li>
                        ...
                        <div class="project-details-carousel">
                            <swiper :options="swiperOptions">
                                <div class="swiper-slide">
                                    <div class="image">
                                        <img class="fit-image" src="/images/project/slide-1.jpg" alt="Project Image">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="image">
                                        <img class="fit-image" src="/images/project/slide-2.jpg" alt="Project Image">
                                    </div>
                                </div>
                            </swiper>
                            ...
                            <div class="swiper-nav-center swiper-button-prev">
                                <i class="icofont-thin-left"></i>
                            </div>
                            <div class="swiper-nav-center swiper-button-next">
                ...
                <div class="row project-right-content-box section-padding mtn-30">
                    <div class="col-lg-8 mt-30 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="300">
                        <!-- Project Box Image Start -->
                        <div class="project-box-image">
                            <img class="fit-image" src="/images/project/medium-1.jpg" alt="Project Image">
                        </div>
                        <!-- Project Box Image End -->
                    </div>
                    <div class="col-lg-4 mt-30 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="500">
                ...
                <div class="row project-left-content-box mtn-30">
                    <div class="col-lg-5 mt-30" data-aos="fade-up" data-aos-delay="300">
                        <!-- Project Box Inner Start -->
                        <div class="project-box-inner">
                            <div class="section-title">
                    ...
                    <div class="col-lg-7 mt-30" data-aos="fade-up" data-aos-delay="500">
                        <!-- Project Box Image Start -->
                        <div class="project-box-image">
                            <img class="fit-image" src="/images/project/medium-2.jpg" alt="Project Image">
                        </div>
                        <!-- Project Box Image End -->
                    </div>
                </div>
                ...
                <div class="row section-padding">
                    <div class="col-lg-8 offset-lg-2 col-md-12" data-aos="fade-up" data-aos-delay="300">
...
<script>
    export default {
        components: {
            TheHeaderTwo: () => import('@/components/TheHeaderTwo'),
